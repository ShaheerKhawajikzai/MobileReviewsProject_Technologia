...
{
    public class AddDeviceModelRequestHandler : IRequestHandler<AddDeviceModelRequest, AddDeviceModelResponse>
    {
        private readonly ApplicationDbContext _dbContext;
        private readonly IMediator Mediator;
        private readonly IWebHostEnvironment webHostEnvironment;
        public AddDeviceModelRequestHandler(ApplicationDbContext dbContext, IMediator mediator, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<AddDeviceModelResponse> Handle(AddDeviceModelRequest request, CancellationToken cancellationToken)
        {
            ...
            return new AddDeviceModelResponse() { IsSuccess = true, Message = "Device Updated Successfully." };
